...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class=" treeview">
         ...
         <a id="addItem" href="#" data-toggle="modal" data-target="#login-modal">
            <i class="fa  fa-cart-plus"></i> <span >Add Category</span>
            <span class="pull-right-container">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h2>
        Dashboard
        <small>Admin>items/Services ><%unityCategory%></small>
      </h2>
      <ol class="breadcrumb">
    ...
    @include('otherView.addCategoryForm')
    </section>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
  ...
  @include('otherView.reviews')
    ...
    <strong>&copy; 2017-2020 <a href="http://sachinkumar.epizy.com/?i=1">Sachin Kumar</a>.</strong> All rights
    reserved.
  </footer>
...
@include('otherView.editItemForm')
@endsection