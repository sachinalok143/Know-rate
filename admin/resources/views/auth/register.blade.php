...
<div class="alert-danger " style="text-align: center; padding: 5px; border: solid 1px brown; border-radius: 5px;">
    <b>Registration will be success only <br> your contact number is recomended by a super admin</b>
</div>
</div><br>
<br><br><br>
    ...
    <div class="contentform">
      <div class="leftcontact">
        ...
        <div class="form-group{{ $errors->has('contact') ? ' has-error' : '' }}">
            ...
            @endif   
            @if($recomemdationError)
            <div >
                <span class="help-block" style="color: brown;">
                    <strong>{{ $recomemdationError['contact']}}</strong>
                </span>
            </div>
            @endif   
        </div>
