...
<div style="padding: 10px; border: solid 1px brown; border-radius: 5px; text-align: center;" class="alert-danger" ng-if="!items.length">
	<span >No item/service that you can purchase yet.</span>
</div>
</div>
<center>
...
<div ng-if="items.length" class="panel">
	<div class="panel-heading">
	 ...
	 <br><label class="alert-info" style="border:solid 1px blue; border-radius: 3px; padding: 3px; ">
	Total items/services&nbsp;:&nbsp;<%items.length%>
	<br>
	<span ng-if="Category"> Category: <%Category%></span>
		        ...
		        <div class="col-md-8  col-md-offset-2">
		            <div class="panel panel-default">
		                <div class="panel-heading" style="">
		                	<%item.name%><span style="float: right;"><%item.categoryId%></span>
		                </div>
		                <div class="panel-body" style="">
		                <div class="col-md-3">		
	            			<img style="max-height: 150px; " src="http://localhost:8081/uploads/itemImage/<%item.photo%>">
	            		</div>	
	            		<div class="col-md-6">
