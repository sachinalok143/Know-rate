...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class=" active treeview">
          <a href="#">
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
              <span class="label label-primary pull-right"><%categories.length%></span>
            </span>
          </a>
          <ul class="treeview-menu" ng-if="categories">
             <li><a ng-click="getItemByCategory({id:'0',name:''})"><i class="fa fa-circle-o"></i> All</a></li>
            <li><a ng-click="getItemByCategory(category)" ng-repeat="category in categories"><i class="fa fa-circle-o"></i> <%category.name%></a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="http://cse.iitkgp.ac.in/~sachin.kumar">Sachin kumar</a>.</strong> All rights
    reserved.
  </footer>
