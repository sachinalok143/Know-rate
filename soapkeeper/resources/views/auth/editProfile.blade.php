...
<div class="modal-dialog">
    ...
    <div class="contentform">
      <div class="leftcontact">
        ...
        <div class="form-group{{ $errors->has('shopName') ? ' has-error' : '' }}">
          ...
          <input class="input-class" type="text" name="shopName" value="{{Auth::user()->shopName}}" id="shopName" data-rule="shopName" pattern="[A-Za-z\s]{1,100}" required>
  ...
  <div class="rightcontact">  
      ...
      <span class="icon-case"><i class="fa fa-map-marker"></i></span>
        <input class="input-class" type="text" name="landmark" value="{{ Auth::user()->landmark }}" id="landmark" data-rule="required" >
