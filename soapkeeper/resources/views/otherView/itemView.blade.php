...
<div ng-if="items.length" class="panel">
	...
	<br><span ng-if="unityCategory"> Category&nbsp;:&nbsp;<%unityCategory%></span>
	 ...
	 <div class="col-md-2" style="float: right;" data-toggle="offcanvas">
	 	<button class="form-control btn btn-success" href="#" data-toggle="modal" data-target="#login-modal">Add item</button>
	 </div>
	</div>
